...
const rootRouteChildren: RootRouteChildren = { IndexRoute, AdminRoute, AuthRoute, CommunityRoute, ExploreRoute, NotificationsRoute, PartnerRoute, RulesRoute, SettingsRoute, UploadRoute, WatchRoute, CUsernameRoute, PlaylistsRoute, PlaylistPlaylistIdRoute, AboutRoute }
