...
const DICT: Record<LanguageId, Record<string, string>> = {
  ...
  en: {
    ...
    "Subir video": "Upload video", "Playlists": "Playlists", "Todavía no has subido videos": "You haven't uploaded any videos yet",
    ...
    "Subir video": "Upload video", "Publicación nueva": "New upload", "Título": "Title", "Categoría": "Category", "Descripción": "Description", "Visibilidad": "Visibility",
    ...
    "Personalizar canal": "Customize channel", "Diseño del canal": "Channel design", "Perfil": "Profile", "Imágenes": "Images", "Partner": "Partner",
    ...
    "Información del canal": "Channel information", "Suscriptores": "Subscribers", "Videos": "Videos", "Estilo": "Style",
    ...
    "Explorar": "Explore", "About": "About", "Press & Blogs": "Press & Blogs", "Copyright": "Copyright", "Creators & Partners": "Creators & Partners",
