...
export const themes: ThemeDefinition[] = [
  ...
  { id: "retro2012", name: "Cosmic Panda 2012", category: "custom", kind: "theme", description: "Experiencia clara en contenido con guía oscura y chrome propio.", stylesheets: ["/cosmic-panda-theme.css"], family: "cornet-historical", pages: ["home", "watch", "shorts", "explore", "settings"] },
