...
export type DesignStylesheet = {
  href: string;
  loadFor?: (themeId: string) => boolean;
};
...
/**
 * Single source of truth for Cornet's design system.
 *
 * Themes control the global shell/appearance. Layouts control channel pages.
 * A design entry should never import routes or application providers.
 */
export const themes: ThemeDefinition[] = [
  ...
  {
    id: "retro2012",
    name: "Cosmic Panda 2012",
    category: "custom",
    kind: "theme",
    description: "Experiencia global inspirada en Cosmic Panda / YouTube 2012.",
    stylesheets: [
      "/retro2012.css",
      "/cosmic-panda-custom-theme.css",
      "/cosmic-panda-2012.css",
      "/cosmic-panda-sidebar-fix.css",
      "/cosmic-panda-light.css",
    ],
  },
  {
    id: "feather2013",
    ...
    category: "custom",
    kind: "theme",
    description: "Experiencia ligera y enfocada en vídeo.",
    stylesheets: ["/retro2012.css", "/custom-theme-experiences.css"],
  },
  {
    id: "youtube2019",
    name: "YouTube 2019 / Polymer",
    category: "custom",
    kind: "theme",
    description: "Experiencia global basada en Polymer 2019.",
    stylesheets: ["/youtube-polymer-2019.css"],
  },
  {
    id: "windowsAero",
    name: "Windows Aero",
    category: "custom",
    kind: "theme",
    description: "Cristal, blur y chrome inspirado en Vista/7.",
    stylesheets: ["/custom-theme-experiences.css", "/aero-family-overrides.css"],
  },
  {
    id: "frutigerAero",
    name: "Frutiger Aero",
    category: "custom",
    kind: "theme",
    description: "Naturaleza, agua, cielo y vidrio translúcido.",
    stylesheets: ["/custom-theme-experiences.css", "/aero-family-overrides.css"],
  },
  {
    id: "web2Glossy",
    ...
    category: "custom",
    kind: "theme",
    description: "Glossy, gradients, chrome y skeuomorfismo web.",
    stylesheets: ["/custom-theme-experiences.css", "/aero-family-overrides.css"],
  },
  {
    id: "y2kChrome",
    ...
    category: "custom",
    kind: "theme",
    description: "Metal, azul eléctrico y estética tecnológica Y2K.",
    stylesheets: ["/custom-theme-experiences.css"],
  },
  {
    id: "xpLuna",
    ...
    category: "custom",
    kind: "theme",
    description: "Chrome azul, superficies plateadas y controles Luna.",
    stylesheets: ["/custom-theme-experiences.css"],
  },
  {
    id: "crtVhs",
    ...
    category: "custom",
    kind: "theme",
    description: "Scanlines, fósforo, glow y estética de televisión antigua.",
    stylesheets: ["/custom-theme-experiences.css"],
  },
];
...
export const channelLayouts: ChannelLayoutDefinition[] = [
  ...
  { id: "cosmicPanda", name: "Cosmic Panda Channel", category: "historical", kind: "layout", description: "Layout de canal Cosmic Panda.", stylesheets: ["/cosmic-panda-channel-fullpage.css", "/cosmic-panda-channel-layout.css"] },
...
export function getTheme(themeId: string) {
  return themes.find((theme) => theme.id === themeId) ?? themes.find((theme) => theme.id === "grad-ocean")!;
}

export function getChannelLayout(layoutId: string) {
  return channelLayouts.find((layout) => layout.id === layoutId) ?? channelLayouts[0];
}

export function getThemesByCategory(category: DesignCategory) {
