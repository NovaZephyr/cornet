...
export const themes: ThemeDefinition[] = [
  ...
  { id: "retro2012", name: "Cosmic Panda", category: "custom", kind: "theme", description: "Tema Cosmic Panda fusionado con la implementación histórica Retro 2012; conserva retro2012 como identificador interno para compatibilidad.", stylesheets: ["/cosmic-panda-theme.css"], family: "cornet-historical", pages: ["home", "watch", "shorts", "explore", "settings"] },
  { id: "youtube2009", name: "YouTube 2009", category: "custom", kind: "theme", description: "Tema histórico independiente con esquema de colores rojo y azul característico de 2009.", stylesheets: ["/youtube2009.css"], family: "youtube-historical", pages: ["home", "watch", "shorts", "explore", "settings"] },
  { id: "feather2013", name: "Feather 2013", category: "custom", kind: "theme", description: "Tema claro ligero y autónomo inspirado en YouTube principios de 2013; no activa layouts históricos adicionales.", stylesheets: ["/feather-2013-enhanced.css"], family: "youtube-historical", pages: ["home", "watch", "shorts", "explore", "settings"] },
