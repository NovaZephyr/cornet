...
export const channelLayouts: ChannelLayoutDefinition[] = [
  ...
  { id: "classic-2009", name: "Classic 2009", category: "historical", kind: "layout", description: "Canal compacto inspirado en 2009.", stylesheets: [] },
  ...
  { id: "onechannel-2013", name: "One Channel 2013", category: "historical", kind: "layout", description: "Portada de canal centrada en el banner.", stylesheets: [] },
  ...
  { id: "channel-2015", name: "2015 Channel", category: "historical", kind: "layout", description: "Intermedio entre el canal clásico y moderno.", stylesheets: [] },
  { id: "channel-2019", name: "YouTube 2019 Channel", category: "historical", kind: "layout", description: "Canal con estructura de la era Polymer.", stylesheets: [] },
];
