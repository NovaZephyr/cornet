    ...
    const onKey = (e: KeyboardEvent) => {
      ...
      switch (e.key) {
        ...
        case "k":
          ...
          break;
        case "ArrowRight":
          seekTo(Math.min(v.currentTime + 5, duration));
          break;
        case "ArrowLeft":
          seekTo(Math.max(v.currentTime - 5, 0));
          break;
        case "ArrowUp":
          e.preventDefault();
    ...
    >
      ...
      >
        ...
        <div className="group/bar relative mb-2 h-1.5 w-full cursor-pointer rounded-full bg-white/25">
          ...
          />
          <div
            className="pointer-events-none absolute top-1/2 h-3 w-3 -translate-y-1/2 -translate-x-1/2 rounded-full bg-primary opacity-0 group-hover/bar:opacity-100"
        ...
        <div className="flex items-center gap-3 text-white">
          ...
          <div className="group/vol flex items-center gap-1.5">
            ...
            <input
              ...
              className="h-1 w-0 cursor-pointer opacity-0 transition-all group-hover/vol:w-16 group-hover/vol:opacity-100"
              aria-label="Volumen"
            />
          </div>
          ...
          <div className="ml-auto flex items-center gap-3">
            <div className="relative">
              ...
              {showSpeedMenu && (
                <div className="absolute bottom-8 right-0 w-20 rounded-lg bg-black/90 py-1 text-xs shadow-lg">
                  {SPEEDS.map((s) => (
                    <button
                      key={s}
