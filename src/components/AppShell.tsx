...
import { Home, Users, Upload, Search, Menu, Shield, Sparkles, Settings, LogOut, User as UserIcon, Video, Compass, Bell, Palette, Check, Megaphone, ListVideo, Info, Languages, Wrench, MessageCircle, X } from "lucide-react";
  ...
  return <div className="cn-2012-app min-h-screen bg-background">
    ...
    <header className="cn-2012-topbar sticky top-0 z-50 flex h-16 items-center gap-2 border-b border-border/60 px-2 backdrop-blur-xl sm:px-4">
      ...
      <div className="ml-auto flex items-center gap-1">
        <div className="hidden sm:flex items-center gap-1"><TwemojiPicker /><LanguageMenu userId={user?.id} /><ThemeMenu /></div>
