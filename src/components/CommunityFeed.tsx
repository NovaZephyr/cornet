...
export function CommunityFeed({ channelId }: { channelId?: string | undefined }) {
  ...
  const publish = async (e: React.FormEvent) => {
    ...
    try {
      ...
      void notifyMentions(content.trim(), `/community#post-${post.id}`, `${profile?.display_name || profile?.username || "Alguien"} te mencionó en una publicación de comunidad.`);
