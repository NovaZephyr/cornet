...
function ExplorePage() {
  ...
  const sections = [{ title: "Más vistos hoy", data: popular.data ?? [] }, { title: "Recomendado para ti", data: recent.data ?? [] }, ...CATEGORIES.map((category, index) => ({ title: category, data: categoryQueries[index]?.data ?? [] }))];
