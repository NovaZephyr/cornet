...
function MaintenanceAwareContent() {
  ...
  if (MAINTENANCE_MODE && !loading && !isAdmin && !isAuthRoute) {
    return <MaintenanceScreen canAccessAdmin={false} />;
  }
