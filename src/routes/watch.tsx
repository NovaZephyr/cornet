...
function Watch() {
  ...
  const shareVideo = async () => {
    ...
    try {
      ...
      toast.success("Enlace del video copiado");
    } catch {
      window.prompt("Copia este enlace para compartir el video:", shareUrl);
    }
  };
